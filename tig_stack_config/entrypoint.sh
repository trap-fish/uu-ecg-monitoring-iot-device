...
export DOCKER_MQTT_BROKER_INIT_PORT=$DOCKER_MQTT_BROKER_INIT_PORT
export DOCKER_MQTT_WEB_INIT_PORT=$DOCKER_MQTT_WEB_INIT_PORT
export DOCKER_MQTT_INIT_HOST=$DOCKER_MQTT_INIT_HOST
